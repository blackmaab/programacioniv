        ...
        <div id="wrapper">
            <div id="header-wrapper" class="container">
                <div id="header" class="container">
                    ...
                    <div id="menu">
                        <ul>
                            <li class="current_page_item"><a href="?mod=homeUser">Inicio</a></li>
                            <li><a href="?mod=newCurriculum">Creaci&oacute;n de Curriculum</a></li>
                            <li><a href="?mod=viewAccountUser">Cuenta</a></li>
